...
class Productos extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // 🔹 Redirige directamente al formulario de compra del nuevo producto
            return redirect()->route('compras.create', ['id_producto' => $item->id])
                             ->with('success', 'Producto creado exitosamente. Ahora puedes registrar su compra.');
        } catch (\Throwable $th) {
