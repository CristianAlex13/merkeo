...
// Actualizar precio desde ventas
Route::post('/actualizar-precio/{id_producto}', [Ventas::class, 'actualizar_precio'])->name('ventas.actualizar.precio');

// Tickets
Route::get('/detalle-venta/ticket/{id}', [DetalleVentas::class, 'generarTicket'])->name('detalle-venta.ticket');
...
// Productos (tu controlador se llama Productos)
Route::prefix('productos')->middleware(['auth', 'Checkrol:admin'])->group(function () {
    ...
    Route::get('/estado/{id}/{estado}', [Productos::class, 'estado'])->name('productos.estado');
