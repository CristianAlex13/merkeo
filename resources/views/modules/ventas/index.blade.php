                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      {{-- Campo editable para cambiar el precio (añadido) --}}
                      <td class="text-center">
                        <form action="{{ route('ventas.actualizar.precio', $item['id']) }}" method="POST" class="d-inline">
                          @csrf
                          <input type="number" name="precio" value="{{ $item['precio'] }}" min="0" step="0.01" style="width:90px; display:inline-block;" class="form-control text-center">
                          <button type="submit" class="btn btn-warning btn-sm mt-1">Actualizar</button>
                        </form>
                      </td>
